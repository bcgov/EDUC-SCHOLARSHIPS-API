...
--Create table in the migration schema
CREATE TABLE SDC_SCHOOL_COLLECTION_STUDENT
(	
     ASSIGNED_PEN VARCHAR2(10),
     ENROLLED_GRADE_CODE VARCHAR2(10),
     SCHOOL_FUNDING_CODE VARCHAR2(10),
     DOB VARCHAR2(8),
     FTE NUMBER(5,4),
     SDC_SCHOOL_COLLECTION_ID VARCHAR2(40),
     SDC_SCHOOL_COLLECTION_STUDENT_STATUS_CODE VARCHAR2(10)
);
...
FOR rec IN (
    SELECT
      ...
      STUDENT_FTE_VALUE, BIRTH_DATE, STUD_NO, SCHOOL_FUNDING_CODE
    ...
    INSERT INTO STUDENT@SLDLINK.WORLD VALUES (
      ...
      NULL, NULL, NULL, NULL, NULL, NULL, NULL, rec.STUD_NO, NULL,
