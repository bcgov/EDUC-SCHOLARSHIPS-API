package ca.bc.gov.educ.scholarships.api.util;

import ca.bc.gov.educ.scholarships.api.properties.ApplicationProperties;
import ca.bc.gov.educ.scholarships.api.struct.v1.BaseRequest;
...
public class RequestUtil {
  ...
  public static void setAuditColumnsForCreate(@NotNull BaseRequest baseRequest) {
    if (StringUtils.isBlank(baseRequest.getCreateUser())) {
      baseRequest.setCreateUser(ApplicationProperties.SCHOLARSHIPS_API);
    }
  ...
  public static void setAuditColumnsForUpdate(@NotNull BaseRequest baseRequest) {
    if (StringUtils.isBlank(baseRequest.getUpdateUser())) {
      baseRequest.setUpdateUser(ApplicationProperties.SCHOLARSHIPS_API);
    }
