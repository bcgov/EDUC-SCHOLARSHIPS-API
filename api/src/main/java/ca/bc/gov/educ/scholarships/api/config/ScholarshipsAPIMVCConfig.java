package ca.bc.gov.educ.scholarships.api.config;
 ...
 */
@Configuration
public class ScholarshipsAPIMVCConfig implements WebMvcConfigurer {
   ...
   */
  @Autowired
  public ScholarshipsAPIMVCConfig(final RequestResponseInterceptor requestResponseInterceptor) {
