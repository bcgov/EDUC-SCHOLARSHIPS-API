...
public interface StudentAddressAPIEndpoint {
  ...
  StudentAddress createStudentAddress(@PathVariable UUID studentID, @Validated @RequestBody StudentAddress studentAddress) throws JsonProcessingException;
  ...
  @Tag(name = "Student Address Entity", description = "Endpoints for student address entity.")
  @Schema(name = "StudentAddress", implementation = StudentAddress.class)
  StudentAddress updateStudentAddress(@PathVariable UUID studentID, @PathVariable UUID studentAddressID, @Validated @RequestBody StudentAddress studentAddress) throws JsonProcessingException;
